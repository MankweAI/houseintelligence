...
export function AgentCard({ agent, suburbName }: AgentCardProps) {
    return (
        <Card className="overflow-hidden hover:shadow-lg transition-shadow border-stone-200">
            <div className="flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-48 h-48 md:h-auto relative bg-stone-100 shrink-0">
                    ...
                    <div className="absolute top-2 left-2">
                        <Badge className="bg-white/90 text-stone-900 border-none shadow-sm backdrop-blur-sm">
                            {agent.agency}
                        </Badge>
                    </div>
                </div>
