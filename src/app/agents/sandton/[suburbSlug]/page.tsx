        ...
        <main className="min-h-screen bg-stone-50">
            ...
            <section className="relative min-h-[500px] flex items-end pb-12 px-6">
                ...
                <div className="relative z-10 w-full max-w-6xl mx-auto">
                    <Link href="/agents/sandton" className="text-amber-500 hover:text-amber-400 text-sm font-bold tracking-widest uppercase mb-4 inline-block">
                        ← Back to Sandton 20
                    </Link>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    {agents.length > 0 ? (
                        ...
                        <div className="p-12 text-center bg-stone-100 rounded-2xl border-2 border-dashed border-stone-300">
                            ...
                            <Link href="/agents/sandton" className="text-amber-600 font-bold hover:underline mt-2 inline-block">
