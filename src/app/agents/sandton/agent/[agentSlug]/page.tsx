        ...
        <main className="min-h-screen bg-stone-50">
            ...
            <section className="bg-white border-b border-stone-200 pt-24 pb-12 px-6">
                <div className="max-w-5xl mx-auto">
                    <Link href="/agents/sandton" className="text-stone-400 hover:text-stone-600 text-sm font-bold tracking-widest uppercase mb-8 inline-block">
                        ← Back to Directory
                    </Link>
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-stone-200">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {agent.areas.map(area => (
                                        <Link
                                            key={area}
                                            href={`/agents/sandton/${area.toLowerCase().replace(/\s+/g, '-')}`}
