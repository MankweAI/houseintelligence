    ...
    return (
        <div className="bg-slate-50 min-h-screen">
                    ...
                    <FadeIn>
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 leading-tight">
                                Sell Smarter in
                                <span className="block text-emerald-400 mt-2">South Africa's Top Cities</span>
                            </h1>
                            ...
                            <div className="flex flex-wrap justify-center gap-4 mb-12">
                                <div className="bg-white/10 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/10">
                                    <div className="text-sm text-slate-400">Live Cities</div>
                                    <div className="text-2xl font-bold text-emerald-400">1</div>
                                </div>
                                <div className="bg-white/10 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/10">
                                    <div className="text-sm text-slate-400">Suburbs</div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 -mt-8">
                ...
                {/* Why Hyper-Local */}
                <section className="bg-white rounded-3xl shadow-lg border border-slate-100 p-8 md:p-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span className="text-slate-700">City-specific market cycles and seasonality</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <TrendingUp className="h-5 w-5 text-emerald-600 shrink-0 mt-0.5" />
                                    <span className="text-slate-700">Suburb-level buyer demographics and motivations</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <TrendingUp className="h-5 w-5 text-emerald-600 shrink-0 mt-0.5" />
                                    <span className="text-slate-700">Local agents with proven track records</span>
                                </li>
                            </ul>
                        </div>

                        <div className="bg-slate-50 rounded-2xl p-8">
                            <h3 className="font-serif font-bold text-xl text-slate-900 mb-4">Coming Soon</h3>
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-200">
                                    <div>
                                        <div className="font-semibold text-slate-900">Cape Town</div>
                                        <div className="text-sm text-slate-500">Atlantic Seaboard expansion</div>
                                    </div>
                                    <div className="text-sm font-medium text-emerald-600">Q2 2026</div>
                                </div>
                                <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-200">
                                    <div>
                                        <div className="font-semibold text-slate-900">Johannesburg</div>
                                        <div className="text-sm text-slate-500">Northern suburbs focus</div>
                                    </div>
                                    <div className="text-sm font-medium text-slate-600">Q3 2026</div>
                                </div>
                                <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-200">
                                    <div>
                                        <div className="font-semibold text-slate-900">Pretoria</div>
                                        <div className="text-sm text-slate-500">Eastern suburbs</div>
                                    </div>
                                    <div className="text-sm font-medium text-slate-600">Q4 2026</div>
                                </div>
                            </div>
                        </div>
                    </div>
